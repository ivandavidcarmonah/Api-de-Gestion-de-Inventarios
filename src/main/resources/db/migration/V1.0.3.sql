...
CREATE TABLE `developer_blog` (
  ...
  `imagen_header` varchar(45) DEFAULT NULL,
  `imagen_body` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `RRnrkcidigvkemps7kkfn25nvg1` (`title`),
  KEY `FK Creteby dev` (`created_by`),
  KEY `FK Update dev` (`update_by`),
  KEY `FK Delete dev` (`deleted_by`),
...
-- Dump completed on 2022-11-09 15:24:51
